...
V1 skeleton / baseline validation is archived in `docs/archive/v1/`. V1-A is accepted and archived; the next development task is `docs/iterations/v1-b-embedding-similarity.md`.
...
- `docs/iterations/v1-b-embedding-similarity.md`
- `docs/15-迭代执行记录.md`
- `docs/16-V1开发收口清单.md`
- `docs/archive/v1/`
