...
| §3.2 | Multimodal Preference Modeling | `docs/20-多模态偏好建模设计文档.md` | **created** | V4-A 验收后；V6 归档后复核 | V6 已完成 image/audio/video runtime boundary；真实 audio/video 内容解析继续 carry_over |
